...
public class IdentitiesTest {
    ...
    /**
     * reader方式
     * readX509Certificate用于读取pem证书，该测试用于检测，读错内容时，是否会报IOException错误
     */
    @Test
